  ...
  return (
    <div className=' pt-[10%] flex justify-center'>
      <form className='grid grid-cols-12' onSubmit={(e) => e.preventDefault()}>
        <input ref={searchText} className=' col-span-10 px-6 py-2 rounded ' placeholder={language[langKey].placeholder} />
        <button
          onClick={() => handleSearch()}
          className=' font-semibold col-span-2 px-6 py-2 bg-red-700 text-white rounded '>
